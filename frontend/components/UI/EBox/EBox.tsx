...
export default function EBox(props: EBoxProps) {
	...
	const cornerBox = !noCorners && (
		<div
			className={`absolute inset-0 -z-10 -m-[2px] ${styles.outer_box} ${notched ? styles.outer_box_notched : ""
	...
	return (
		<div
			className={`relative ${!borderless ? "border" : ""} ${bgColor ? `bg-[${bgColor}]` : active ? "bg-[#000a17]" : "bg-[#00000020]"
